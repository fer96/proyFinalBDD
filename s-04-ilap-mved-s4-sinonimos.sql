...
create or replace synonym laptop_f2 for laptop_f2_drf_s1@fdlrsbd_s1;
...
create or replace synonym laptop_f1 for laptop_f5_mved_s4;
--laptop_inventario
...
create or replace synonym tipo_procesador_s4 for tipo_procesador_mved_s4;
--tipo_tarjeta_video
create or replace synonym tipo_tarjeta_video_s1 for tipo_tarjeta_video_drf_s1@fdlrsbd_s1;
create or replace synonym tipo_tarjeta_video_s2 for tipo_tarjeta_video_mved_s2@mved_s1;
create or replace synonym tipo_tarjeta_video_s3 for tipo_tarjeta_video_drf_s3@fdlrsbd_s2;
create or replace synonym tipo_tarjeta_video_s4 for tipo_tarjeta_video_mved_s4;
--tipo_almacenamiento
create or replace synonym tipo_almacenamiento_s1 for tipo_almacenamiento_drf_s1@fdlrsbd_s1;
create or replace synonym tipo_almacenamiento_s2 for tipo_almacenamiento_mved_s2@mved_s21;
create or replace synonym tipo_almacenamiento_s3 for tipo_almacenamiento_drf_s3@fdlrsbd_s2;
create or replace synonym tipo_almacenamiento_s4 for tipo_almacenamiento_mved_s4
--tipo_monitor
...
create or replace synonym tipo_monitor_s4 for tipo_monitor_mved_s4;
--status_laptop
create or replace synonym status_laptop_s1 for status_laptop_drf_s1@fdlrsbd_s1;
create or replace synonym status_laptop_s2 for status_laptop_mved_s2@mved_s1;
create or replace synonym status_laptop_s3 for status_laptop_drf_s3@fdlrsbd_s2;
create or replace synonym status_laptop_s4 for status_laptop_mved_s4;