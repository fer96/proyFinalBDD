...
CREATE TABLE HISTORICO_STATUS_LAPTOP_F1(
...
CREATE TABLE SERVICIO_LAPTOP_F2(
...
CREATE TABLE SUCURSAL_TALLER_F2(
    SUCURSAL_ID          NUMBER(10, 0)    NOT NULL,
    ...
    CONSTRAINT RefSUCURSAL_F21 FOREIGN KEY (SUCURSAL_ID)
    REFERENCES SUCURSAL_F2(SUCURSAL_ID)
)
;
