...
--@Descripcion: Creacion de vistas con archivos blob sitio 3
...
create or replace view servicio_laptop as
	...
	get_remote_serv_lap_f1_by_id(num_servicio, laptop_id),sucursal_id 
	from servicio_laptop_f1
	union all
	select num_servicio,laptop_id,importe,diagnostico,
	get_remote_serv_lap_f2_by_id(num_servicio,laptop_id),sucursal_id
	...
	union all
	select num_servicio,laptop_id,importe,diagnostico,
	get_remote_serv_lap_f4_by_id(num_servicio,laptop_id),sucursal_id
