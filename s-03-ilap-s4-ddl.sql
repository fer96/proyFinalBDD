...
CREATE TABLE SERVICIO_LAPTOP_F4(
    ...
    REFERENCES LAPTOP_F5(LAPTOP_ID)
)
;
...
CREATE TABLE SUCURSAL_TALLER_F4(
    SUCURSAL_ID          NUMBER(10, 0)    NOT NULL,
    ...
    CONSTRAINT RefSUCURSAL_F41 FOREIGN KEY (SUCURSAL_ID)
...
CREATE TABLE SUCURSAL_VENTA_F4(
    ...
    CONSTRAINT RefSUCURSAL_F42 FOREIGN KEY (SUCURSAL_ID)
    REFERENCES SUCURSAL_F4(SUCURSAL_ID)
)
;
