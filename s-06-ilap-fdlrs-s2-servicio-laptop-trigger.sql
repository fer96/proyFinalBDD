...
--@Descripcion: Creacion de trigger para la tabla servicio laptop sitio 3

create or replace trigger t_dml_servicio_laptop_s3
...
begin
	case
		when inserting then
			...
			--insercion local
			if v_count > 0 then
				insert into ti_servicio_laptop_f3(laptop_id,num_servicio,sucursal_id,
				...
				select laptop_id,num_servicio,sucursal_id,
					importe,diagnostico,factura from ti_servicio_laptop_f3
				where laptop_id = :new.laptop_id
				...
				--insercion remota s2
				if v_count > 0 then
					insert into ti_servicio_laptop_f2(laptop_id,num_servicio,sucursal_id,
						importe,diagnostico,factura)
					values(:new.laptop_id,:new.num_servicio,:new.sucursal_id,
						:new.importe,:new.diagnostico,:new.factura);
					insert into servicio_laptop_f2(laptop_id,num_servicio,sucursal_id,
						importe,diagnostico,factura)
					select laptop_id,num_servicio,sucursal_id,
						importe,diagnostico,factura from ti_servicio_laptop_f2
					where laptop_id = :new.laptop_id
					and num_servicio = :new.num_servicio;
					...
					--insercion remota s1
					if v_count > 0 then
						insert into ti_servicio_laptop_f1(laptop_id,num_servicio,sucursal_id,
							importe,diagnostico,factura)
						values(:new.laptop_id,:new.num_servicio,:new.sucursal_id,
							:new.importe,:new.diagnostico,:new.factura);
						insert into servicio_laptop_f1(laptop_id,num_servicio,sucursal_id,
							importe,diagnostico,factura)
						select laptop_id,num_servicio,sucursal_id,
							importe,diagnostico,factura from ti_servicio_laptop_f1
						where laptop_id = :new.laptop_id
						and num_servicio = :new.num_servicio;
						...
						--insercion remota s4
						if v_count > 0 then
							insert into ti_servicio_laptop_f4(laptop_id,num_servicio,sucursal_id,
								importe,diagnostico,factura)
							values(:new.laptop_id,:new.num_servicio,:new.sucursal_id,
								:new.importe,:new.diagnostico,:new.factura);
							insert into servicio_laptop_f4(laptop_id,num_servicio,sucursal_id,
								importe,diagnostico,factura)
							select laptop_id,num_servicio,sucursal_id,
								importe,diagnostico,factura from ti_servicio_laptop_f4
							where laptop_id = :new.laptop_id
							and num_servicio = :new.num_servicio;
