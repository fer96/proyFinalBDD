...
create or replace synonym laptop_f2 for laptop_f1_drf_s1;
create or replace synonym laptop_f3 for laptop_f2_mved_s2@mved_s1;
create or replace synonym laptop_f4 for laptop_f3_drf_s3@fdlrsbd_s2;
...
create or replace synonym tipo_tarjeta_video_s1 for tipotarjeta_video_drf_s1;
create or replace synonym tipo_tarjeta_video_s2 for tipotarjeta_video_mved_s2@mved_s1;
create or replace synonym tipo_tarjeta_video_s3 for tipotarjeta_video_drf_s3@fdlrsbd_s2;
...
--status laptop
create or replace synonym tipo_status_laptop_s1 for tipo_status_laptop_drf_s1;
create or replace synonym tipo_status_laptop_s2 for tipo_status_laptop_mved_s2@mved_s1;
create or replace synonym tipo_status_laptop_s3 for tipo_status_laptop_drf_s3@fdlrsbd_s2;
