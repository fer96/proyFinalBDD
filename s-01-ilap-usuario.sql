...
grant create session, create table, create sequence, create procedure, create view, create synonym, create trigger, create database link, create any directory to ilap_bdd;